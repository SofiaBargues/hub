export const RAWG_GAMES_RESPONSE = [
  {
    id: 3498,
...
export const RAWG_GENRES_RESPONSE = [
  {
    id: 4,
    name: "Action",
    slug: "action",
...
export const RAWG_CONSOLA_RESPONSE = [
      {
          "id": 1,
          "name": "PC",
          "slug": "pc",
